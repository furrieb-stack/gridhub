      ...
      <div className="flex-1 flex flex-col px-3.5 overflow-y-auto no-scrollbar pb-4">
        ...
        <div className="mt-auto pt-6 flex flex-col gap-3 px-3">
          ...
          <div className="flex items-center gap-4 pt-1">
            <a href="https://discord.gg/D5VkVmjxqq" target="_blank" rel="noreferrer" className="text-white/30 hover:text-[#5865F2] transition-colors" title="Discord Server">
            ...
            <a href="https://t.me/gridhubapp" target="_blank" rel="noreferrer" className="text-white/30 hover:text-[#0088cc] transition-colors" title="Telegram">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
